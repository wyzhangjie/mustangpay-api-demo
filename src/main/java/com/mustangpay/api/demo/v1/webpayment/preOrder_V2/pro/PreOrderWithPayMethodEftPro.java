package com.mustangpay.api.demo.v1.webpayment.preOrder_V2.pro;
...
import com.mustangpay.api.utils.mustangpay.WProApiUtilsV1;
 ...
 */
@Slf4j
public class PreOrderWithPayMethodEftPro {
    ...
    public static void main(String[] args) {
            ...
            createCashierReq.setCallbackUrl("https://mustangpay.co.za");
            ...
            log.info("createCashierReq:{}",createCashierReq);
            Map<String, Object> result =  WProApiUtilsV1.callMustangPayPreOrderApi("PreOrderWithPayMethodEftTest", createCashierReq, OperationEnum.PRECREATE.getCode());
