 ...
 */
@Slf4j
public class PreOrderWithPayMethodCardPro {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Map<String, Object> result =  WProApiUtilsV1.callMustangPayPreOrderApi("PreOrderWithPayMethodCardTest", createCashierReq, OperationEnum.PRECREATE.getCode());
