 ...
 */
@Slf4j
public class PreOrderWithPayMethodUndepCardTest {
    public static void main(String[] args) throws Exception {
        ...
        params.put("merchantId", "21251002000056217");
        params.put("payMethods", Collections.singletonList("CARD_PAYMENT"));

        Map<String, Object> result = MustangpayApiUtilsV1.callMustangPayPreOrderApi("PreOrderWithPayMethodCardTest", params, OperationEnum.PRECREATE.getCode());
