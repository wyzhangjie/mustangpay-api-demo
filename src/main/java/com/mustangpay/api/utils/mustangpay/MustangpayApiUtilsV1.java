...
@Slf4j
public class MustangpayApiUtilsV1<T> {
    ...
    public  ResponseResult<T> callTest(String logPrefix, Object data,String jumpKey){
        ...
        //body fastjson transfer to ResponseResult<CashierCreateResp>
        ResponseResult<T> parsedResult = JSONObject.parseObject(
                (String) result,
                new TypeReference<ResponseResult<T>>(){});

        return parsedResult;
    }
    public ResponseResult<T> callMustangPayPreOrderApi(String logPrefix, Object data, String jumpKey) {
        boolean success = false;
        String result = null;
        try {
